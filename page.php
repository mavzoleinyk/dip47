...
<div class="row">
  ...
  <div class="col-lg-8 blog__content mb-72">
    <div class="content-box">           
      ...
      <article class="entry mb-0">
        ...
        <?php //if( !is_page(22) ) : get_template_part('parts/section', 'product'); endif;?>

        <?php if( is_page(86) ) : get_template_part('parts/section', 'rewiewsall'); endif;?>
        <?php get_template_part('parts/section', 'product'); ?>
        <?php if( is_page(22) ) : get_template_part('parts/section', 'info'); endif;?>
        <?php if( is_page(22) ) : get_template_part('parts/section', 'fishka'); endif;?>
        <?php if( is_page(22) ) : get_template_part('parts/section', 'advantage'); endif;?>
        <?php if( is_page(22) ) : get_template_part('parts/section', 'action'); endif;?>
  ...
  <aside class="col-lg-4 sidebar sidebar--right">
    ...
    <?php if( !is_page(22) ) : get_template_part('parts/section', 'timer'); endif;?> 
    <?php
